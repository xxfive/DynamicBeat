...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		trackList.add(
				new Track("ghost Title Image.png", "ghost.jpg", "ghost Start.jpg", "ghost Sample.mp3", "ghost.mp3", "The Festival of Ghost"));
		trackList.add(
				new Track("canon Title Image.png", "canon.jpg", "canon Start.jpg", "canon Sample.mp3", "canon.mp3", "Canon"));
		trackList.add(new Track("v3 Title Image.png", "v3.jpg", "v3 Start.jpg", "v3 Sample.mp3", "v3.mp3", "Beethoven Virus"));
